...
public class NumerosEmExtenso {
     ...
     * @since JDK 1.5
     */
    public NumerosEmExtenso(BigDecimal dec) throws NumberFormatException {
        this();
        setNumber(dec);
    }
     ...
     * @since JDK 1.5
     */
    public NumerosEmExtenso(double dec) throws NumberFormatException {
        this();
        setNumber(dec);
    }
    ...
    public String toString() {
        ...
        /* remover o 'um' que aparece nos milhares */
        String aux = buf.toString();
        if (aux.contains("um mil")) {
            aux = aux.substring(3);//remove os 3 primeiros caracteres
        }

        aux = Character.toUpperCase(aux.charAt(0)) + aux.substring(1); //primeira letra em maiuscula
    ...
    public static String formatar(double numero) {
        return new NumerosEmExtenso(new BigDecimal(numero)).toString();
    }
}
